// Super lightweight single icon bundle - only includes what we actually use
...
// Only the icons we actually use in the app
...
export const Mail = createIcon(<><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-10 5L2 7"/></>);
...
export const X = createIcon(<><path d="m18 6-12 12"/><path d="m6 6 12 12"/></>);
...
export const Globe = createIcon(<><circle cx="12" cy="12" r="10"/><path d="m2 12 20 0"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></>);
